...
export const MOCK_HOSPITALS: Hospital[] = [
  // Mumbai Hospitals
  {
    ...
    location: 'Mumbai',
    specializations: ['Primary Care Physician', 'Cardiology', 'Orthopedics', 'Neurology & Neurosurgery'],
    rating: 4.9,
  ...
  },
  {
    ...
    location: 'Mumbai',
    specializations: ['Obstetrics & Gynecology', 'Cardiology', 'Urology'],
    rating: 4.8,
  ...
  },
  {
    ...
    location: 'Mumbai',
    specializations: ['Primary Care Physician', 'Orthopedics', 'Urology', 'Dermatology'],
    rating: 4.7,
  ...
  // Delhi Hospitals
  {
    ...
    location: 'Delhi',
    specializations: ['Cardiology', 'Neurology & Neurosurgery', 'Orthopedics', 'Primary Care Physician'],
    rating: 4.8,
    accreditation: 'JCI Accredited',
    responseTime: '< 2 hours',
  ...
  },
  {
    ...
    location: 'Delhi',
    specializations: ['Obstetrics & Gynecology', 'Cardiology', 'Neurology & Neurosurgery', 'Urology'],
    rating: 4.9,
    accreditation: 'NABH Verified',
    responseTime: '< 2 hours',
  ...
  },
  {
    ...
    location: 'Delhi',
    specializations: ['Dermatology', 'Urology', 'Primary Care Physician', 'Orthopedics'],
    rating: 4.7,
    accreditation: 'ISO Certified',
    responseTime: '< 3 hours',
  ...
  // Bangalore Hospitals
  {
    ...
    location: 'Bangalore',
    specializations: ['Cardiology', 'Orthopedics', 'Neurology & Neurosurgery', 'Primary Care Physician'],
    rating: 4.8,
    accreditation: 'JCI Accredited',
    responseTime: '< 2 hours',
  ...
  },
  {
    ...
    location: 'Bangalore',
    specializations: ['Primary Care Physician', 'Orthopedics', 'Dermatology', 'Urology'],
    rating: 4.7,
    accreditation: 'ISO Certified',
    responseTime: '< 3 hours',
  ...
  // Chennai Hospitals
  {
    ...
    location: 'Chennai',
    specializations: ['Cardiology', 'Orthopedics', 'Neurology & Neurosurgery', 'Obstetrics & Gynecology'],
    rating: 4.9,
    accreditation: 'JCI Accredited',
    responseTime: '< 2 hours',
  ...
  },
  {
    ...
    location: 'Chennai',
    specializations: ['Obstetrics & Gynecology', 'Cardiology', 'Neurology & Neurosurgery', 'Dermatology'],
    rating: 4.8,
    accreditation: 'NABH Verified',
    responseTime: '< 2 hours',
  ...
  // Hyderabad Hospitals
  {
    ...
    location: 'Hyderabad',
    specializations: ['Cardiology', 'Obstetrics & Gynecology', 'Neurology & Neurosurgery', 'Orthopedics'],
    rating: 4.8,
    accreditation: 'JCI Accredited',
    responseTime: '< 2 hours',
