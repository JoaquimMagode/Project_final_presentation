    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      <div className="flex">
        <div className="w-72 bg-white/80 backdrop-blur-xl border-r border-slate-200/50 shadow-xl">
          <div className="p-6">
            <div className="bg-gradient-to-r from-teal-500 to-blue-600 rounded-2xl p-4 mb-6 text-white">
                ...
                <div className="grid grid-cols-3 gap-6">
                  <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/50">
                    ...
                    <div className="space-y-3">
                      {[
                        { name: 'Medical Check Up Report.pdf', size: '2 MB', date: 'Today' },
                        { name: 'Blood Count Report.docx', size: '1 MB', date: '2 days ago' },
                        { name: 'Heart ECG Report.docx', size: '1 MB', date: '1 week ago' }
                      ].map((report, i) => (
                  ...
                  <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/50">
                    ...
                    <div className="space-y-4">
                      {[
                        { condition: 'Covid-19', doctor: 'Dr. Arjun Sharma', status: 'Recovered', date: 'Mar 2024' },
                        { condition: 'Appendicitis Surgery', doctor: 'Dr. Sushant Seth', status: 'Completed', date: 'Feb 2024' },
                        { condition: 'Routine Checkup', doctor: 'Dr. Nitin Kumawat', status: 'Normal', date: 'Jan 2024' }
                      ].map((item, i) => (
      ...
      <div className="bg-slate-900 rounded-3xl p-6 text-white shadow-xl">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="bg-white/5 p-3 rounded-xl border border-white/10 text-center">
            <p className="text-xs font-bold uppercase text-slate-400">Total Doctors</p>
            <p className="text-xl font-black">42</p>
          </div>
          <div className="bg-white/5 p-3 rounded-xl border border-white/10 text-center">
            <p className="text-xs font-bold uppercase text-slate-400">Requests</p>
            <p className="text-xl font-black text-amber-400">12</p>
          </div>
          <div className="bg-white/5 p-3 rounded-xl border border-white/10 text-center">
            <p className="text-xs font-bold uppercase text-slate-400">Confirmed</p>
        ...
        {['DOCTORS', 'REQUESTS', 'AVAILABILITY'].map(tab => (
          <button
            ...
            className={`flex-1 py-3 rounded-xl text-xs font-black uppercase tracking-widest transition-all ${
              activeTab === tab ? 'bg-emerald-600 text-white shadow-lg' : 'bg-white border border-slate-200 text-slate-500'
            }`}
          >
            {tab}
          </button>
