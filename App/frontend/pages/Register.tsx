...
const Register: React.FC = () => {
  ...
  const inputCls = `w-full bg-slate-50 border border-slate-200 rounded-lg px-3.5 py-2.5 text-sm text-slate-900
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4 sm:p-6">
      <div className="w-full max-w-4xl">
        ...
        <div className="grid md:grid-cols-2 rounded-2xl border border-slate-200 bg-white shadow-xl overflow-hidden">
          ...
          <div className="relative hidden md:flex flex-col justify-between p-10 overflow-hidden
            ...
            <div className="relative space-y-6 mt-auto">
              <div className="space-y-3">
                ...
                <h2 className="text-[26px] font-bold text-white leading-[1.15] tracking-tight">
          ...
          {/* Form panel */}
          <div className="flex flex-col justify-center gap-5 p-8 sm:p-10 max-h-[88vh] overflow-y-auto">
